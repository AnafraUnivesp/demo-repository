"""
Django settings for projeto_cad project.
...
#TO-DO update db to use the postgresql / Azure and ElephantDb/Neon/RAILWAY
#DATABASES = {
   #'default': {
...
# Lembrar de confirmar se a pasta static será criada(frontend)
